...
**Заказчик:** Онлайн-платформа изучения языков  
...
- **Контроль качества уроков:** выявлены аномалии в расписании (уроки <20 мин и >2.5 ч) для проверки технических сбоев
- **Проверка гипотез:** опровергнута гипотеза о связи объёма пакета уроков с их средней длительностью. Подтверждено сезонное падение доходов в 2017 году
- **Расчёт ретеншена:** построена воронка удержания по 15+ партнёрским каналам, выявлены наиболее эффективные источники трафика
- **Оптимизация процессов:** определены часы с максимальной вероятностью успешного заказа для логистического сервиса (смежный кейс)
...
FROM (
    ...
    FROM edtech.client_sign_up a
    JOIN edtech.partner_dict b
